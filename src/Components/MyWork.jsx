...
import { Deployed, Source } from '../Assets/icons/Icons';
...
function ProjectCard({ project, isHovered, onMouseEnter, onMouseLeave }) {
    ...
    return (
        <motion.div
            ref={ref}
            className="relative flex flex-col items-center rounded-2xl justify-center bg-gray-100 dark:bg-gray-800 px-1.5 py-2 hover:shadow-xl hover:shadow-gray-800 transition-all duration-500 w-full pb-3 group"
        ...
        >
            ...
            <div className="relative z-10 w-full rounded-2xl">
                <ImageSlider photos={project.photos} cardHovered={isHovered} cardInView={inView} />
                <h3 className="mt-2 text-2xl text-begin text-gray-900 dark:text-white font-ovo capitalize line-clamp-1" title={project.title}>
                    {project.title}
                </h3>
                <p className="mt-1 text-gray-600 dark:text-gray-400 text-md line-clamp-3 leading-7 mb-2">
                    {project.description}
                </p>
                <div className="bg-gray-400 dark:bg-gray-600 min-h-[1.5px] min-w-full" />
...
export default function MyWork() {
    ...
    return (
        <motion.div id="work" className='w-full px-[5%] 2xl:px-[9%] mt-10 pt-10 scroll-mt-8 lg:scroll-mt-10 2xl:scroll-mt-14'>
            ...
            <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo dark:text-gray-400'>Welcome to my development portfolio! Explore a collection of projects showcasing my expertise in development</p>
