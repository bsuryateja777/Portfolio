...
export default function Header() {
    ...
    return (
        <div id="head" className='w-11/12 my-[20px] mt-[90px] md:mt-[113px] 2xl:mt-[160px] max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-3 2xl:gap-4 scroll-mt-28 lg:scroll-mt-32 2xl:scroll-mt-40'>
            ...
            <motion.div className='' initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ duration: 1, type: 'spring', stiffness: 100 }}>
            ...
            <motion.h3 className='flex items-end gap-2 text-lg lg:text-xl  2xl:text-2xl mb-3 font-ovo' initial={{ y: -10, opcaity: 0 }} whileInView={{ y: 0, opcaity: 1 }} transition={{ duration: 0.8, delay: 0.4 }}>
                Hi! I'm Surya Teja Reddy<img src={handIcon} alt="" className='w-8 relative -top-1' />
            </motion.h3>
            <motion.h1 className='text-4xl sm:text-6xl lg:text-[50px] 2xl:text-[66px] font-ovo overflow-hidden' initial={{ y: -12, opcaity: 0 }} whileInView={{ y: 0, opcaity: 1 }} transition={{ duration: 0.8 }}>
